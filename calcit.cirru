...
{} (:package |feather)
  :configs $ {} (:compact-output? true) (:extension |.cljs) (:init-fn |feather.main/main!) (:output |src) (:port 6001) (:reload-fn |feather.main/reload!) (:storage-key |calcit.cirru) (:version |0.3.0-a1)
                    ...
                    :data $ {}
                      ...
                      |r $ %{} :Expr (:at 1615655659087) (:by |rJG4IHzWf)
                        :data $ {}
                          ...
                          |j $ %{} :Leaf (:at 1615655659087) (:by |rJG4IHzWf) (:text |icon)
                  |r $ %{} :Leaf (:at 1615655659087) (:by |rJG4IHzWf) (:text "|\"1: icon name in string")
                    ...
                    :data $ {}
                      ...
                      |j $ %{} :Expr (:at 1615655659087) (:by |rJG4IHzWf)
                        :data $ {}
                          |T $ %{} :Leaf (:at 1615655659087) (:by |rJG4IHzWf) (:text |:font-size)
                          |j $ %{} :Leaf (:at 1615655659087) (:by |rJG4IHzWf) (:text |style)
                  |r $ %{} :Leaf (:at 1615655659087) (:by |rJG4IHzWf) (:text "|\"2: size in number")
                    ...
                    :data $ {}
                      ...
                      |j $ %{} :Expr (:at 1615655659087) (:by |rJG4IHzWf)
                        :data $ {}
                          |T $ %{} :Leaf (:at 1615655659087) (:by |rJG4IHzWf) (:text |:color)
                          |j $ %{} :Leaf (:at 1615655659087) (:by |rJG4IHzWf) (:text |style)
                  |r $ %{} :Leaf (:at 1615655659087) (:by |rJG4IHzWf) (:text "|\"3: color in string")
                    ...
                    :data $ {}
                      ...
                      |j $ %{} :Expr (:at 1584874663522) (:by |rJG4IHzWf)
                        :data $ {}
                          ...
                          |j $ %{} :Expr (:at 1692542536596) (:by |rJG4IHzWf)
                            :data $ {}
                              |D $ %{} :Leaf (:at 1692542537414) (:by |rJG4IHzWf) (:text |nth)
                              |T $ %{} :Leaf (:at 1584874665829) (:by |rJG4IHzWf) (:text |op)
                              |b $ %{} :Leaf (:at 1692542539647) (:by |rJG4IHzWf) (:text |0)
                    ...
                    :data $ {}
                      ...
                      |r $ %{} :Expr (:at 1518157521635) (:by |root)
                        :data $ {}
                          ...
                          |r $ %{} :Expr (:at 1692542601413) (:by |rJG4IHzWf)
                            :data $ {}
                              |D $ %{} :Leaf (:at 1692542602070) (:by |rJG4IHzWf) (:text |::)
                              |L $ %{} :Leaf (:at 1692542602476) (:by |rJG4IHzWf) (:text |:hydrate-storage)
            ...
            :data $ {}
              ...
              |v $ %{} :Expr (:at 1499755354983) (:by nil)
                :data $ {}
                  ...
                  |t $ %{} :Leaf (:at 1692542610251) (:by |rJG4IHzWf) (:text |dispatch!)
          :doc |
        |repeat! $ %{} :CodeEntry
        ...
        |updater $ %{} :CodeEntry
          :code $ %{} :Expr (:at 1499755354983) (:by nil)
            :data $ {}
              ...
              |v $ %{} :Expr (:at 1499755354983) (:by nil)
                :data $ {}
                  |T $ %{} :Leaf (:at 1692542551493) (:by |rJG4IHzWf) (:text |tag-match)
                  |j $ %{} :Leaf (:at 1499755354983) (:by |root) (:text |op)
                  |n $ %{} :Expr (:at 1507399852251) (:by |root)
                    :data $ {}
                      |T $ %{} :Expr (:at 1692542556029) (:by |rJG4IHzWf)
                        :data $ {}
                          |T $ %{} :Leaf (:at 1507399855618) (:by |root) (:text |:states)
                          |b $ %{} :Leaf (:at 1692542557302) (:by |rJG4IHzWf) (:text |cursor)
                          |h $ %{} :Leaf (:at 1692542557542) (:by |rJG4IHzWf) (:text |s)
                      |j $ %{} :Expr (:at 1584874625235) (:by |rJG4IHzWf)
                        :data $ {}
                          ...
                          |r $ %{} :Leaf (:at 1692542559941) (:by |rJG4IHzWf) (:text |cursor)
                          |t $ %{} :Leaf (:at 1692542560149) (:by |rJG4IHzWf) (:text |s)
                  |t $ %{} :Expr (:at 1518157547521) (:by |root)
                    :data $ {}
                      |T $ %{} :Expr (:at 1692542561405) (:by |rJG4IHzWf)
                        :data $ {}
                          |T $ %{} :Leaf (:at 1518157657108) (:by |root) (:text |:hydrate-storage)
                          |b $ %{} :Leaf (:at 1692542562476) (:by |rJG4IHzWf) (:text |data)
                      |j $ %{} :Leaf (:at 1584874637339) (:by |rJG4IHzWf) (:text |data)
                  |u $ %{} :Expr (:at 1615657508015) (:by |rJG4IHzWf)
                    :data $ {}
                      |T $ %{} :Expr (:at 1692542564859) (:by |rJG4IHzWf)
                        :data $ {}
                          |T $ %{} :Leaf (:at 1615657508015) (:by |rJG4IHzWf) (:text |:exhibit)
                          |b $ %{} :Leaf (:at 1692542565671) (:by |rJG4IHzWf) (:text |data)
                      |j $ %{} :Expr (:at 1615657508015) (:by |rJG4IHzWf)
                        :data $ {}
                          ...
                          |v $ %{} :Leaf (:at 1615657513437) (:by |rJG4IHzWf) (:text |data)
                  |v $ %{} :Expr (:at 1692542566589) (:by |rJG4IHzWf)
                    :data $ {}
                      |T $ %{} :Leaf (:at 1692542566876) (:by |rJG4IHzWf) (:text |_)
                      |b $ %{} :Expr (:at 1692542590604) (:by |rJG4IHzWf)
                        :data $ {}
                          |D $ %{} :Leaf (:at 1692542591125) (:by |rJG4IHzWf) (:text |do)
                          |T $ %{} :Expr (:at 1692542569555) (:by |rJG4IHzWf)
                            :data $ {}
                              |T $ %{} :Leaf (:at 1692542570752) (:by |rJG4IHzWf) (:text |eprintln)
                              |b $ %{} :Leaf (:at 1692542575925) (:by |rJG4IHzWf) (:text "|\"unknown op")
                              |h $ %{} :Leaf (:at 1692542577285) (:by |rJG4IHzWf) (:text |op)
                          |b $ %{} :Leaf (:at 1692542594674) (:by |rJG4IHzWf) (:text |store)
          :doc |
      :ns $ %{} :CodeEntry
        :code $ %{} :Expr (:at 1499755354983) (:by nil)
          :data $ {}
                  ...
                  :data $ {}
                    ...
                    |T $ %{} :Expr (:at 1518156274050) (:by |root)
                      :data $ {}
                        ...
                        |r $ %{} :Leaf (:at 1547437698992) (:by |root) (:text "|\"Dispatch:")
                        |v $ %{} :Leaf (:at 1518156280471) (:by |root) (:text |op)
                        |x $ %{} :Leaf (:at 1615657467683) (:by |rJG4IHzWf) (:text |op-data)
                |v $ %{} :Expr (:at 1584780634192) (:by |rJG4IHzWf)
                  :data $ {}
                    |T $ %{} :Leaf (:at 1499755354983) (:by |root) (:text |reset!)
                    |j $ %{} :Leaf (:at 1507399899641) (:by |root) (:text |*reel)
                  ...
                  :data $ {}
                    ...
                    |r $ %{} :Expr (:at 1499755354983) (:by nil)
                      :data $ {}
                        |T $ %{} :Leaf (:at 1499755354983) (:by |root) (:text |comp-container)
                        |j $ %{} :Leaf (:at 1507400119272) (:by |root) (:text |@*reel)
                    |v $ %{} :Expr (:at 1511280014006) (:by |root)
                      :data $ {}
                        |D $ %{} :Leaf (:at 1610793337541) (:by |rJG4IHzWf) (:text |\)
                        |T $ %{} :Leaf (:at 1511280017692) (:by |root) (:text |dispatch!)
                        |j $ %{} :Leaf (:at 1610793401238) (:by |rJG4IHzWf) (:text |%)
                        |r $ %{} :Leaf (:at 1511280021857) (:by |root) (:text |%2)
            :doc |
          |repeat! $ %{} :CodeEntry
            :code $ %{} :Expr (:at 1610793045335) (:by |rJG4IHzWf)
              :data $ {}
              ...
              :data $ {}
                ...
                |r $ %{} :Expr (:at 1499755354983) (:by nil)
                  :data $ {}
                    |T $ %{} :Leaf (:at 1499755354983) (:by |root) (:text |store)
                    |j $ %{} :Leaf (:at 1499755354983) (:by |root) (:text |op)
                    |r $ %{} :Leaf (:at 1584874633844) (:by |rJG4IHzWf) (:text |data)
                    |v $ %{} :Leaf (:at 1519489491135) (:by |root) (:text |op-id)
                    |x $ %{} :Leaf (:at 1519489492110) (:by |root) (:text |op-time)
                |v $ %{} :Expr (:at 1499755354983) (:by nil)
                  :data $ {}
                    |T $ %{} :Leaf (:at 1659198564291) (:by |rJG4IHzWf) (:text |case-default)
                    |j $ %{} :Leaf (:at 1499755354983) (:by |root) (:text |op)
                    |l $ %{} :Leaf (:at 1659198567034) (:by |rJG4IHzWf) (:text |store)
                    |n $ %{} :Expr (:at 1507399852251) (:by |root)
                      :data $ {}
                        |T $ %{} :Leaf (:at 1507399855618) (:by |root) (:text |:states)
                        |j $ %{} :Expr (:at 1584874625235) (:by |rJG4IHzWf)
                          :data $ {}
                            |T $ %{} :Leaf (:at 1584874626558) (:by |rJG4IHzWf) (:text |update-states)
                            |j $ %{} :Leaf (:at 1584874628374) (:by |rJG4IHzWf) (:text |store)
                            |r $ %{} :Leaf (:at 1584874632002) (:by |rJG4IHzWf) (:text |data)
                    |t $ %{} :Expr (:at 1518157547521) (:by |root)
                      :data $ {}
                        |T $ %{} :Leaf (:at 1518157657108) (:by |root) (:text |:hydrate-storage)
                        |j $ %{} :Leaf (:at 1584874637339) (:by |rJG4IHzWf) (:text |data)
